...
::通过 VS Code 打开文件
reg add "HKEY_CLASSES_ROOT\*\shell\VS Code" /ve /t REG_SZ /d "通过 VS Code 打开" /f 1>NUL 2>NUL
...
::通过 VS Code 打开文件夹
reg add "HKEY_CLASSES_ROOT\Directory\shell\VS Code" /ve /t REG_SZ /d "通过 VS Code 打开" /f 1>NUL 2>NUL
